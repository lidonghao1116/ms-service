...
public class PayInfo implements Serializable{
    ...
    public PayInfo(OnlineOrderInfo o,String payNo, String tradeChannel, String reqUrl, String reqXml) {
        this.payNo = payNo;
        this.userId = o.getUserId();
        this.orderNo = o.getOrderNo();
        this.orderDesc = o.getOrderDesc();
        this.amount = Integer.valueOf(Math.round(o.getAmount() * 100)+"");
        this.tradeChannel = tradeChannel;
        this.requestTime = o.getOrderTime();
        this.requestInfo = reqXml;
        this.requestUrl = reqUrl;
        this.originChannel = o.getOriginChannel();
    }
